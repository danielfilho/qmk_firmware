...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_default(
    ...
    KC_PGDN, KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,             KC_H,   KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,
             ...
             KC_LCTL,          KC_LALT, KC_SPC,  KC_RGUI,                          KC_SPC,           MO(_FN1),          KC_RCTL
  ),

  [_FN1] = LAYOUT_default(
    KC_MPLY,  _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, KC_DEL,
    KC_VOLU,  _______,  _______, KC_UP,  _______, _______, RGB_TOG,          RGB_SAI, RGB_HUI, RGB_VAI, _______, _______, _______, _______, KC_DEL,
    KC_VOLD,  _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, RGB_MOD,          RGB_SAD, RGB_HUD, RGB_VAD, _______, _______, _______,          _______,
  ...
  [_FN2] = LAYOUT_default(
    ...
    KC_MNXT,  _______,  _______, _______,  _______, _______, _______,         _______, _______, _______, _______, _______, _______, _______, _______,
    KC_MPRV, _______,  _______, _______,  _______, _______, _______,          _______, _______, _______, _______, _______, _______,          _______,
